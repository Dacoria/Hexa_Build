public static class Statics
{
    ...
    public static string LOAD_PATH_MATERIAL_COLORS = "Colors";
    public static string LOAD_PATH_SPRITE_HEX = "Sprites/Hex";
    public static string LOAD_PATH_SPRITE = "Sprites";
}